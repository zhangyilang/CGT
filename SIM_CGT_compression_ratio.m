...
methods = {
    'RGT ($c=1$)', 1, @(y,psi,k)MOLS_cK(y,psi,1,k,eps,S), 'k', '-', '+';...
    'RGT+Bin ($c=1$)', 2, @(y_bin,psi,k)MOLS_cK(y_bin,psi,1,k,eps,S), 'k', '-', 'o';...
    'RGT ($c=2$)', 1, @(y,psi,k)MOLS_cK(y,psi,2,k,eps,S), 'b', '-', 'x';...
    'RGT+Bin ($c=2$)', 2, @(y_bin,psi,k)MOLS_cK(y_bin,psi,2,k,eps,S), 'b', '--', 'd';...
    'RGT ($c=4$)', 1, @(y,psi,k)MOLS_cK(y,psi,4,k,eps,S), 'r', '-', 's';...
    'RGT+Bin ($c=4$)', 2, @(y_bin,psi,k)MOLS_cK(y_bin,psi,4,k,eps,S), 'r', ':', '^';...
    'RGT ($c=8$)', 1, @(y,Psi,k)MOLS_cK(y,Psi,8,k,eps,S), [0,0.6,0.6], '-', 'h';...
    'RGT+Bin ($c=8$)', 2, @(y_bin,Psi,k)MOLS_cK(y_bin,Psi,8,k,eps,S), [0,0.6,0.6], '-.', '>';...
    };
